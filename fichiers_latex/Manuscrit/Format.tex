...
% Width parameters
\setlength{\oddsidemargin}{2.5cm} %Valeur des marges pages impaires mettre 4cm
\setlength{\evensidemargin}{2.5cm} %Valeur des marges pages paires mettre 2cm
\setlength{\textwidth}{16cm} %Largeur du texte 15cm il reste donc 6cm pour les marges droite et gauches

% Hight parameters
%\setlength{\topmargin}{2cm}
\setlength{\topmargin}{1.5cm}
\setlength{\headheight}{16pt} %28 ptPermet de caser deux lignes de 12pt de haut dans l'entete
%28pt} %Permet de caser deux lignes de 12pt de haut dans l'entete
